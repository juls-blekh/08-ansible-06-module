...
Выполнение playbook завершается с ошибкой. Модуль не видит. Пробовала 2 варианта вызова модуля - просто по названию и с указанием namespace и имени коллекции.
